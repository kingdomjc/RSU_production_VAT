...
def T_02_mainPowerTest_M(product):
    u"电源网络短路测试3-RSDB5单板主输入电源及各分支电源网络是否短路测试"
...
def T_03_branchPowerTest_M(product):
    u"电源网络电压精度测试3-RSDB5单板上电后各电源网络电压精度测试"
    powerList = ['1.2V','1.0V']
    alist = []
    for i in powerList:
