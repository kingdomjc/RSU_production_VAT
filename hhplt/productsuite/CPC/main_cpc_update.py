...
def cpc_card_update():
    ...
    if ret != '':
        print "\n***** inter_auth_key_2 update failed *****\n"
    ...
    ret = update_master_key(new_master_key, DE_DELIVERY) # do not delivery
    if ret != '':
        print "\n***** master key of DF01 update failed *****\n"
