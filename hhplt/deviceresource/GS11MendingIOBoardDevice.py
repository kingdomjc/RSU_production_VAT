...
基于工位的配置，但有些变化：
> 平行进出改成了上下；去掉了两个感应器及气缸；
> 防拆气缸也去掉了，所以深度静态电流没办法测了.
...
class GS11MendingIOBoardDevice(TestResource):
    '''开关量IO板设备'''
...
class IOBoardAutoTrigger(AbstractAutoTrigger):
    ...
    def __init__(self):
        ...
        self.board = askForResource("GS11IOBoardDevice", GS11MendingIOBoardDevice)    #启动IO板卡
